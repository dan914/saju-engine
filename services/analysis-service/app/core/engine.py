...
class AnalysisEngine:
    ...
    def analyze(self, request: AnalysisRequest) -> AnalysisResponse:
        ...
        structure_result = self.structure_detector.evaluate(StructureContext(scores=structure_scores))
        ...
        recommendation = self.recommendation_guard.decide(structure_primary=structure_result.primary)
