...
def find_matches():
    ...
    for engine_id, engine_pillars in engine_results.items():
        ...
        for ft_id, ft_pillars in ft_data.items():
            ...
            if (engine_pillars['year'] == ft_pillars['year'] and
                engine_pillars['month'] == ft_pillars['month'] and
                engine_pillars['day'] == ft_pillars['day'] and
                engine_pillars['hour'] == ft_pillars['hour']):
    ...
    if matches_found:
        ...
        for match in matches_found:
            ...
            print(f"{same_id:15} | Engine: {match['engine_id']:4} | FT: {match['ft_id']:4} | "
