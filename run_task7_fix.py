...
request1 = TimeConversionRequest(
    instant=datetime(2000, 9, 14, 10, 0, 0), source_tz="Asia/Seoul", target_tz="UTC"
)
...
request2 = TimeConversionRequest(
    instant=datetime(1988, 5, 8, 2, 0, 0), source_tz="Asia/Seoul", target_tz="UTC"
)
...
request3 = TimeConversionRequest(
    instant=datetime(2015, 8, 15, 0, 0, 0), source_tz="Asia/Pyongyang", target_tz="UTC"
)
...
request4 = TimeConversionRequest(
    instant=datetime(1987, 7, 1, 0, 0, 0), source_tz="Asia/Seoul", target_tz="UTC"
)
